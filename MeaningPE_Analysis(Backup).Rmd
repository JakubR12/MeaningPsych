...
#data transformation
MLQ_p <- pivot_longer(
  MLQ, c(MLQ_b_p_score, MLQ_2wa_p_score, MLQ_4wa_p_score), names_to = "MLQ_p_type", values_to = "MLQ_p_score")
...
# formula
MLQ_p_f <- bf (MLQ_p_score ~ 1 +  MLQ_p_type*Other + (1|ID) + (1|MLQ_QN) + (1|Intended_drug_use))


get_prior(MLQ_p_f, MLQ_p, family = cumulative())
